		...
		def _callback(self, listener):
			...
			while True:
				try:
					...
					print "Transcript: " + transcripts[-1]
					break
...
def run(fname):
	...
	CLIENT_KEY = "X2wXOTbU4Kn2pXgXkdYiRSRRNbPgC1uBvLMkHVJ9ZxSre-M4BNMDu3GdfcVJuh3zM2cQOwfnO0iMM12_i56AAA=="
	CLIENT_ID = "5rorpqZcACqMS5AGmQ6m4Q=="
